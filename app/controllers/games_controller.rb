class GamesController < ApplicationController
  ...
  def index
    respond_to do |format|
      ...
      format.json { render json: @games, include: %i[home_team visiting_team], status: 200 }
    end
  end
  ...
  def game_params
    params.require(:game).permit(:sport, :gender, :level, :home_team, :visiting_team, :location, :max_capacity,
